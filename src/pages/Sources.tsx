...
const EXAMPLE_QUERIES = [
  'Requirements for Shabbat candle lighting',
  'What does the Talmud say about honoring parents?',
  'Obligations of tzedakah',
  'Kiddush on Shabbat morning',
  'Teshuvah and repentance',
  'Sources on lashon hara',
]
    ...
    <div className="mx-auto max-w-3xl space-y-6 md:space-y-8">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-kula-500 dark:text-kula-400">
          Ask any Jewish question — real Torah sources, fetched live from Sefaria.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex gap-2">
        <input
          ...
          placeholder="e.g. Requirements for Shabbat candle lighting…"
          disabled={isLoading}
      ...
      {data && !isLoading && (
        <div className="animate-fade-in space-y-6">
          ...
          <div className="rounded-xl border border-kula-400/30 bg-kula-400/5 p-5 dark:border-kula-400/20 dark:bg-kula-400/5">
            ...
            <p className="mt-3 text-[10px] text-kula-400 dark:text-kula-600">
              Generated by Claude · Sources verified via Sefaria
            </p>
          </div>
